import pytest
from use_case_enrichment import (
    enrich_use_cases,
    enrich_use_case,
    extract_optional_features,
    extract_error_cases,
    should_merge_use_cases,
    merge_use_cases,
    normalize_use_case
)
...
def test_enrich_use_case_preserves_existing(complete_use_case):
    ...
    assert all(p in enriched["preconditions"] for p in complete_use_case["preconditions"])
